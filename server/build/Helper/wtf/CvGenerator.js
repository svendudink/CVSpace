...
if (fs.existsSync(`./logos/JS.png`)) {
  console.log("nailed it1xsdc");
} else {
  console.log("fail");
}
if (fs.existsSync(`./JS.png`)) {
...
if (fs.existsSync(`app/server/JS.png`)) {
...
if (fs.existsSync(`/server/JS.png`)) {
...
const ImgColorConvert = (file, textHexColor) =>
  __awaiter(void 0, void 0, void 0, function* () {
    return new Promise((resolve, reject) => {
      console.log(textHexColor, "valid");
      replaceColor(
        {
          image: fs.readFile(`server/${file}`),
          colors: {
            type: "hex",
            targetColor: "#000000",
        ...
        (err, jimpObject) => {
          ...
          jimpObject.write(`server/${textHexColor}${file}`, (err) => {
            if (err) {
  ...
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
      ...
      const skillArray = [
        ...
        {
          imgLink: `./logos/${textColor}groq.png`,
          name: "GROQ",
          skillScore: 2,
        },
        {
      ...
      doc
        .fontSize(sFont)
        .text(
          `02/22-07/22 Code Academy Berlin`,
          mmToPtX(baseLineX),
      ...
      doc
        .fontSize(sFont)
        .text(
          `front end Development, Backend development, Android testing, Debugging, code maintenance,  automation Script writing, `,
          mmToPtX(baseLineX),
